export default {
	...
	"components.board.menu.checkboxElement": "Checkbox settings",
	"components.board.menu.assignmentElement": "Assignment settings",
	...
	"components.boardProgress.doneOf": "{done}/{total} done",
	"components.boardProgress.classProgress": "{done}/{total} of the class done",
	"components.boardProgress.students.allDone": "All done",
	"components.boardProgress.students.openItems": "Still open",
	"components.boardProgress.students.overdue": "overdue",
	...
	"components.cardElement.checkboxElement.audience.all": "Everyone",
	"components.cardElement.checkboxElement.audience.custom": "Custom",
	"components.cardElement.checkboxElement.audienceRole.reader": "Reader",
	"components.cardElement.checkboxElement.audienceRole.editor": "Editor",
	"components.cardElement.checkboxElement.audienceRole.admin": "Admin",
	...
	"components.cardElement.checkboxElement.checked": "Done",
	"components.cardElement.checkboxElement.unchecked": "Not done",
	"components.cardElement.pollElement.titleLabel": "Title",
	"components.cardElement.pollElement.questionLabel": "Question {number}",
	"components.cardElement.pollElement.answerModeLabel": "Answer type",
	"components.cardElement.pollElement.chartTypeLabel": "Chart type",
	"components.cardElement.pollElement.optionLabel": "Answer {number}",
	"components.cardElement.pollElement.addQuestion": "Add question",
	"components.cardElement.pollElement.addOption": "Add answer",
	"components.cardElement.pollElement.answerMode.single": "Single choice",
	"components.cardElement.pollElement.answerMode.multiple": "Multiple choice",
	"components.cardElement.pollElement.answerMode.text": "Free text",
	"components.cardElement.pollElement.chartType.bar": "Bar (horizontal)",
	"components.cardElement.pollElement.chartType.column": "Column (vertical)",
	"components.cardElement.pollElement.chartType.donut": "Donut",
	"components.cardElement.pollElement.chartType.stacked": "Stacked bar",
	"components.cardElement.pollElement.anonymous": "Anonymous poll",
	"components.cardElement.pollElement.liveResults": "Show results live",
	"components.cardElement.pollElement.allowVoteChange": "Allow changing submitted answers",
	"components.cardElement.pollElement.audienceLabel": "Who can vote?",
	"components.cardElement.pollElement.audience.students": "Students only",
	"components.cardElement.pollElement.audience.teachers": "Teachers & staff",
	"components.cardElement.pollElement.audience.all": "All room members",
	"components.cardElement.pollElement.audience.custom": "Custom…",
	"components.cardElement.pollElement.audienceRolesLabel": "Eligible roles",
	"components.cardElement.pollElement.audienceRole.reader": "Viewers",
	"components.cardElement.pollElement.audienceRole.editor": "Editors",
	"components.cardElement.pollElement.audienceRole.admin": "Admins & owners",
	"components.cardElement.pollElement.audienceLockedHint":
		"The audience can no longer be changed once a vote has been cast.",
	"components.cardElement.pollElement.structureLockedHint":
		"Once a vote has been cast, questions and options can only be added, not removed. The answer type can no longer be changed either.",
	"components.cardElement.pollElement.status.draft": "Draft",
	"components.cardElement.pollElement.status.open": "Open",
	"components.cardElement.pollElement.status.closed": "Closed",
	"components.cardElement.pollElement.open": "Open",
	"components.cardElement.pollElement.close": "Close",
	"components.cardElement.pollElement.vote": "Vote",
	"components.cardElement.pollElement.changeVote": "Change answer",
	"components.cardElement.pollElement.voteRecorded": "Your answer has been recorded.",
	"components.cardElement.pollElement.votedCount": "{voted} of {total} voted",
	"components.cardElement.pollElement.closesAt": "Closes on",
	"components.cardElement.pollElement.opensAtLabel": "Start time",
	"components.cardElement.pollElement.remainingMinutes": "{minutes} min left",
	"components.cardElement.pollElement.closed": "Closed",
	"components.cardElement.pollElement.startsAtLabel": "Start: {date}",
	"components.cardElement.pollElement.closesAtLabel": "End: {date}",
	"components.cardElement.pollElement.notStartedYet": "Starts on {date}",
	"components.cardElement.pollElement.exportCsv": "Export as CSV",
	"components.cardElement.pollElement.exportPdf": "Export as PDF",
	"components.cardElement.pollElement.emptyResults": "No votes yet",
	"components.cardElement.pollElement.freeTextAnswer": "Answer",
	"components.cardElement.pollElement.answerLocked": "Already answered",
	"components.cardElement.pollElement.newQuestions": "New",
	"components.cardElement.pollElement.voteError": "Your vote could not be submitted.",
	"components.cardElement.pollElement.analysis": "Detailed view",
	"components.cardElement.pollElement.overview": "Overview",
	"components.cardElement.pollElement.participants": "Participants",
	"components.cardElement.pollElement.closeAnalysis": "Close analysis",
	"components.cardElement.pollElement.previousQuestion": "Previous question",
	"components.cardElement.pollElement.nextQuestion": "Next question",
	"components.cardElement.pollElement.noParticipants": "No participation yet",
	"components.cardElement.pollElement.unknownUser": "Unknown person",
	"components.cardElement.pollElement.answerColumn": "Answer",
	"components.cardElement.pollElement.nameColumn": "Name",
	"components.cardElement.assignmentElement": "Assignment",
	...
	"components.cardElement.assignmentElement.graceMinutes.none": "None",
	"components.cardElement.assignmentElement.graceMinutes.15m": "15 minutes",
	"components.cardElement.assignmentElement.graceMinutes.1h": "1 hour",
	"components.cardElement.assignmentElement.graceMinutes.12h": "12 hours",
	"components.cardElement.assignmentElement.graceMinutes.1d": "1 day",
	"components.cardElement.assignmentElement.graceMinutes.3d": "3 days",
	"components.cardElement.assignmentElement.maxPoints": "Maximum points",
	"components.cardElement.assignmentElement.points": "{points} / {maxPoints} points",
	"components.cardElement.assignmentElement.uploadFile": "Upload file",
	"components.cardElement.assignmentElement.replaceFile": "Replace file",
	"components.cardElement.assignmentElement.closed": "Submissions are closed",
	"components.cardElement.assignmentElement.viewSubmissions": "View submissions ({submitted}/{total})",
	"components.cardElement.assignmentElement.submittedOf": "{submitted} of {total} submitted",
	"components.cardElement.assignmentElement.submissionsProgress": "{graded} graded · {open} open",
	"components.cardElement.assignmentElement.submissionsTitle": "Submissions",
	"components.cardElement.assignmentElement.pointsLabel": "Points",
	...
	"components.cardElement.assignmentElement.audioUpload": "Upload",
	"components.cardElement.assignmentElement.exportCsv": "Export CSV",
	...
	"components.cardElement.assignmentElement.sectionSubmission": "Submission",
	"components.cardElement.assignmentElement.sectionCorrection": "My correction",
	"components.cardElement.assignmentElement.correctionFile": "Correction ({date})",
	"components.cardElement.assignmentElement.filter.all": "All",
	"components.cardElement.assignmentElement.filter.open": "Open",
	"components.cardElement.assignmentElement.filter.submitted": "Submitted",
	"components.cardElement.assignmentElement.filter.returned": "Returned",
	"components.cardElement.assignmentElement.filter.late": "Late",
	"components.cardElement.assignmentElement.sort.name": "Name (A–Z)",
	"components.cardElement.assignmentElement.sort.nameDesc": "Name (Z–A)",
	"components.cardElement.assignmentElement.sort.date": "Submission date (newest)",
	"components.cardElement.assignmentElement.sort.status": "Status",
	"components.cardElement.assignmentElement.csv.name": "Name",
	"components.cardElement.assignmentElement.csv.status": "Status",
	"components.cardElement.assignmentElement.csv.submittedAt": "Submitted at",
	"components.cardElement.assignmentElement.csv.late": "Late",
	"components.cardElement.assignmentElement.csv.points": "Points",
	"components.cardElement.assignmentElement.csv.file": "File",
	"components.cardElement.assignmentElement.feedbackHeading": "Feedback",
	"components.cardElement.assignmentElement.viewFile": "View",
	...
	"components.cardElement.assignmentElement.annotator.comment": "Comment",
	"components.cardElement.assignmentElement.annotator.commentPlaceholder": "Type a comment",
	"components.cardElement.assignmentElement.annotator.commentDone": "Done",
	...
	"components.cardElement.assignmentElement.annotator.widthThick": "Thick line",
	"components.cardElement.assignmentElement.annotator.colorBlack": "Black",
	"components.cardElement.assignmentElement.annotator.colorRed": "Red",
	"components.cardElement.assignmentElement.annotator.colorBlue": "Blue",
	"components.cardElement.assignmentElement.annotator.colorGreen": "Green",
	"components.cardElement.assignmentElement.annotator.page": "Page {current} of {total}",
	"components.cardElement.assignmentElement.annotator.fingerDraws": "Finger draws",
	"components.cardElement.assignmentElement.annotator.fingerNavigates": "Finger navigates",
	"components.cardElement.assignmentElement.annotator.fitToPage": "Fit to page",
	"components.cardElement.assignmentElement.batchReturn.selectAllGraded": "Select all graded",
	"components.cardElement.assignmentElement.batchReturn.button": "Return {count}",
	"components.cardElement.assignmentElement.batchReturn.confirmTitle": "Batch return",
	"components.cardElement.assignmentElement.batchReturn.confirmBody": "{count} submissions will be returned.",
	"components.cardElement.assignmentElement.batchReturn.resultSuccess": "{count} submissions returned.",
	"components.cardElement.assignmentElement.batchReturn.resultPartialFailure":
		"{returned} returned, {failed} skipped (not graded yet).",
	"components.cardElement.assignmentElement.versions.entry": "Version {version} · {date}",
	"components.cardElement.assignmentElement.rubric.enable": "Use a grading rubric",
	"components.cardElement.assignmentElement.rubric.criterionName": "Criterion",
	"components.cardElement.assignmentElement.rubric.criterionMaxPoints": "Max. points",
	"components.cardElement.assignmentElement.rubric.addCriterion": "Add criterion",
	"components.cardElement.assignmentElement.rubric.removeCriterion": "Remove criterion",
	"components.cardElement.assignmentElement.peerReview.enable": "Enable peer review",
	"components.cardElement.assignmentElement.peerReview.mode": "Assignment mode",
	"components.cardElement.assignmentElement.peerReview.modeManual": "Manual",
	"components.cardElement.assignmentElement.peerReview.modeAuto": "Automatic",
	"components.cardElement.assignmentElement.peerReview.count": "Reviewers per submission",
	"components.cardElement.assignmentElement.peerReview.autoAssign": "Auto-assign",
	"components.cardElement.assignmentElement.peerReview.manualAssign": "Assign",
	"components.cardElement.assignmentElement.peerReview.manageTitle": "Manage peer review",
	"components.cardElement.assignmentElement.peerReview.manageButton": "Peer review",
	"components.cardElement.assignmentElement.peerReview.selectReviewer": "Select reviewer",
	"components.cardElement.assignmentElement.peerReview.removeAssignment": "Remove assignment",
	"components.cardElement.assignmentElement.peerReview.assignmentSubmitted": "Already submitted - cannot be removed",
	"components.cardElement.assignmentElement.peerReview.autoAssignSuccess": "{count} assignments made.",
	"components.cardElement.assignmentElement.peerReview.manualAssignSuccess": "Assignment saved.",
	"components.cardElement.assignmentElement.peerReview.myTasks": "My peer reviews",
	"components.cardElement.assignmentElement.peerReview.noTasks": "No peer reviews to do right now.",
	"components.cardElement.assignmentElement.peerReview.submitReview": "Submit review",
	"components.cardElement.assignmentElement.peerReview.reviewSubmitted": "Review saved.",
	...
	"components.cardElement.aiQuestionElement": "AI question",
	"components.cardElement.aiQuestionElement.question": "Question",
	"components.cardElement.aiQuestionElement.questionPlaceholder": "Ask a question …",
	"components.cardElement.aiQuestionElement.aiInstructions": "Instructions for the AI",
	"components.cardElement.aiQuestionElement.aiInstructionsPlaceholder":
		"What should the AI consider? How should it answer?",
	"components.cardElement.aiQuestionElement.expectedAnswer": "Expected answer",
	...
	"components.cardElement.aiQuestionElement.gradeLevel": "Grade level (optional)",
	"components.cardElement.aiQuestionElement.subject": "Subject (optional)",
	"components.cardElement.aiQuestionElement.pointsEnabled": "Grade the answer with points",
	"components.cardElement.aiQuestionElement.maxPoints": "Maximum points",
	"components.cardElement.aiQuestionElement.points": "{points} of {maxPoints} points",
	"components.cardElement.aiQuestionElement.aiFlagged": "The AI marked this answer as off-topic.",
	"components.cardElement.aiQuestionElement.flagAssessment": "Disagree with assessment",
	"components.cardElement.aiQuestionElement.unflagAssessment": "Remove review flag",
	"components.cardElement.aiQuestionElement.flaggedForReview": "Flagged for review",
	"components.cardElement.aiQuestionElement.studentFlagged": "Flagged by student",
	"components.cardElement.aiQuestionElement.evaluation": "AI question evaluation",
	"components.cardElement.aiQuestionElement.openEvaluation": "Open evaluation",
	"components.cardElement.aiQuestionElement.gradedCount": "With points: {count}",
	"components.cardElement.aiQuestionElement.flaggedCount": "Flagged: {count}",
	"components.cardElement.aiQuestionElement.noPoints": "No point grading",
	"components.cardElement.aiQuestionElement.studentAnswer": "Student answer",
	"components.cardElement.aiQuestionElement.selectAnswer": "Select an answer",
	...
	"components.cardElement.aiQuestionElement.resubmit": "Submit a new answer",
	"components.cardElement.aiQuestionElement.attempt": "Attempt {count}",
	"components.cardElement.aiQuestionElement.singleAttemptHint": "You can only answer this question once.",
	"components.cardElement.aiQuestionElement.aiResponseTitle": "AI assessment",
	"components.cardElement.aiQuestionElement.aiError": "The AI is currently unavailable. Please try again later.",
	"components.cardElement.aiQuestionElement.aiThinking": "The AI is assessing your answer …",
	...
	"components.cardElement.aiQuestionElement.attemptsColumn": "Attempts",
	"components.board.menu.aiQuestionElement": "AI question settings",
	...
	"components.cardElement.assignmentElement.status.returned": "Returned",
	"components.cardElement.assignmentElement.status.late": "late",
	"pages.assignments.current": "Current",
	...
	"components.elementTypeSelection.elements.checkboxElement.subtitle": "Checkbox",
	"components.elementTypeSelection.elements.aiQuestionElement.subtitle": "AI question",
	"components.elementTypeSelection.elements.assignmentElement.subtitle": "Assignment",
	...
	"global.topbar.actions.openMenu": "Open menu",
	"global.topbar.actions.closeMenu": "Close menu",
	"global.topbar.theme.label": "Appearance",
	"global.topbar.theme.system": "System",
	"global.topbar.theme.light": "Light",
	"global.topbar.theme.dark": "Dark",
	...
	"pages.dashboard.features.dismiss": "Dismiss",
	...
	"pages.dashboard.tasks.group.overdue": "Overdue",
	"pages.dashboard.tasks.group.today": "Due today",
	"pages.dashboard.tasks.group.thisWeek": "Due this week",
	"pages.dashboard.tasks.group.later": "Due later",
	"pages.dashboard.tasks.group.noDueDate": "No due date",
	"pages.dashboard.tasks.legend": "Legend: task status",
	...
	"pages.news.index.new": "Create news",
	...
	"pages.room.progress.title": "Progress",
	"pages.room.progress.empty": "There are no assignments, checkboxes or polls in this room yet.",
	"pages.room.progress.doneOf": "{done}/{total} done",
	"pages.room.progress.tab.students": "Students",
	"pages.room.progress.tab.items": "Content",
	...
	"pages.roomDetails.progress.link": "View progress",
