export default {
	...
	"pages.learningRoom.empty.description":
		"Mark cards in your rooms with the pin icon. They will show up here — still connected to the original.",
	"pages.learningRoom.empty.action": "Go to my rooms",
	"pages.learningRoom.groupBy.status": "By status",
	"pages.learningRoom.groupBy.room": "By room",
	"pages.learningRoom.card.unavailable": "This card is no longer available.",
	"pages.learningRoom.column.roomFallback": "Without room",
