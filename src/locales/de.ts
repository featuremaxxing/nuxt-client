export default {
	...
	"components.board.menu.checkboxElement": "Checkbox-Einstellungen",
	"components.board.menu.assignmentElement": "Aufgabe-Einstellungen",
	...
	"components.boardProgress.doneOf": "{done}/{total} abgeschlossen",
	"components.boardProgress.classProgress": "{done}/{total} der Klasse abgeschlossen",
	"components.boardProgress.students.allDone": "Alles erledigt",
	"components.boardProgress.students.openItems": "Noch offen",
	"components.boardProgress.students.overdue": "überfällig",
	...
	"components.cardElement.checkboxElement.audience.all": "Alle",
	"components.cardElement.checkboxElement.audience.custom": "Benutzerdefiniert",
	"components.cardElement.checkboxElement.audienceRole.reader": "Lesen",
	"components.cardElement.checkboxElement.audienceRole.editor": "Bearbeiten",
	"components.cardElement.checkboxElement.audienceRole.admin": "Verwalten",
	...
	"components.cardElement.checkboxElement.checked": "Erledigt",
	"components.cardElement.checkboxElement.unchecked": "Nicht erledigt",
	"components.cardElement.pollElement.titleLabel": "Titel",
	"components.cardElement.pollElement.questionLabel": "Frage {number}",
	"components.cardElement.pollElement.answerModeLabel": "Antworttyp",
	"components.cardElement.pollElement.chartTypeLabel": "Diagrammtyp",
	"components.cardElement.pollElement.optionLabel": "Antwort {number}",
	"components.cardElement.pollElement.addQuestion": "Frage hinzufügen",
	"components.cardElement.pollElement.addOption": "Antwort hinzufügen",
	"components.cardElement.pollElement.answerMode.single": "Einfachauswahl",
	"components.cardElement.pollElement.answerMode.multiple": "Mehrfachauswahl",
	"components.cardElement.pollElement.answerMode.text": "Freitext",
	"components.cardElement.pollElement.chartType.bar": "Balken (waagerecht)",
	"components.cardElement.pollElement.chartType.column": "Säulen (senkrecht)",
	"components.cardElement.pollElement.chartType.donut": "Donut",
	"components.cardElement.pollElement.chartType.stacked": "Gestapelter Balken",
	"components.cardElement.pollElement.anonymous": "Anonyme Umfrage",
	"components.cardElement.pollElement.liveResults": "Ergebnisse live anzeigen",
	"components.cardElement.pollElement.allowVoteChange": "Antworten nachträglich änderbar",
	"components.cardElement.pollElement.audienceLabel": "Wer darf abstimmen?",
	"components.cardElement.pollElement.audience.students": "Nur Schüler:innen",
	"components.cardElement.pollElement.audience.teachers": "Lehrkräfte & Team",
	"components.cardElement.pollElement.audience.all": "Alle Raummitglieder",
	"components.cardElement.pollElement.audience.custom": "Benutzerdefiniert…",
	"components.cardElement.pollElement.audienceRolesLabel": "Stimmberechtigte Rollen",
	"components.cardElement.pollElement.audienceRole.reader": "Betrachter:innen",
	"components.cardElement.pollElement.audienceRole.editor": "Bearbeiter:innen",
	"components.cardElement.pollElement.audienceRole.admin": "Admins & Eigentümer:innen",
	"components.cardElement.pollElement.audienceLockedHint":
		"Die Zielgruppe kann nach der ersten Stimme nicht mehr geändert werden.",
	"components.cardElement.pollElement.structureLockedHint":
		"Fragen und Optionen können nach der ersten Stimme nur noch hinzugefügt, nicht mehr entfernt werden. Der Antworttyp lässt sich dann ebenfalls nicht mehr ändern.",
	"components.cardElement.pollElement.status.draft": "Entwurf",
	"components.cardElement.pollElement.status.open": "Offen",
	"components.cardElement.pollElement.status.closed": "Geschlossen",
	"components.cardElement.pollElement.open": "Öffnen",
	"components.cardElement.pollElement.close": "Schließen",
	"components.cardElement.pollElement.vote": "Abstimmen",
	"components.cardElement.pollElement.changeVote": "Antwort ändern",
	"components.cardElement.pollElement.voteRecorded": "Deine Antwort wurde gespeichert.",
	"components.cardElement.pollElement.votedCount": "{voted} von {total} abgestimmt",
	"components.cardElement.pollElement.closesAt": "Endet am",
	"components.cardElement.pollElement.opensAtLabel": "Startzeit",
	"components.cardElement.pollElement.remainingMinutes": "noch {minutes} Min",
	"components.cardElement.pollElement.closed": "Beendet",
	"components.cardElement.pollElement.startsAtLabel": "Start: {date}",
	"components.cardElement.pollElement.closesAtLabel": "Ende: {date}",
	"components.cardElement.pollElement.notStartedYet": "Startet am {date}",
	"components.cardElement.pollElement.exportCsv": "Als CSV exportieren",
	"components.cardElement.pollElement.exportPdf": "Als PDF exportieren",
	...
	"components.cardElement.pollElement.answerLocked": "Bereits beantwortet",
	"components.cardElement.pollElement.newQuestions": "Neu",
	...
	"components.cardElement.pollElement.previousQuestion": "Vorherige Frage",
	"components.cardElement.pollElement.nextQuestion": "Nächste Frage",
	"components.cardElement.pollElement.noParticipants": "Noch keine Teilnahme",
	"components.cardElement.pollElement.unknownUser": "Unbekannte Person",
	"components.cardElement.pollElement.answerColumn": "Antwort",
	"components.cardElement.pollElement.nameColumn": "Name",
	"components.cardElement.assignmentElement": "Aufgabe",
	...
	"components.cardElement.assignmentElement.graceMinutes.none": "Keine",
	"components.cardElement.assignmentElement.graceMinutes.15m": "15 Minuten",
	"components.cardElement.assignmentElement.graceMinutes.1h": "1 Stunde",
	"components.cardElement.assignmentElement.graceMinutes.12h": "12 Stunden",
	"components.cardElement.assignmentElement.graceMinutes.1d": "1 Tag",
	"components.cardElement.assignmentElement.graceMinutes.3d": "3 Tage",
	"components.cardElement.assignmentElement.maxPoints": "Maximale Punktzahl",
	"components.cardElement.assignmentElement.points": "{points} / {maxPoints} Punkte",
	"components.cardElement.assignmentElement.uploadFile": "Datei hochladen",
	"components.cardElement.assignmentElement.replaceFile": "Datei ersetzen",
	"components.cardElement.assignmentElement.closed": "Abgabe nicht mehr möglich",
	"components.cardElement.assignmentElement.viewSubmissions": "Abgaben ansehen ({submitted}/{total})",
	"components.cardElement.assignmentElement.submittedOf": "{submitted} von {total} abgegeben",
	"components.cardElement.assignmentElement.submissionsProgress": "{graded} bewertet · {open} offen",
	"components.cardElement.assignmentElement.submissionsTitle": "Abgaben",
	"components.cardElement.assignmentElement.pointsLabel": "Punkte",
	...
	"components.cardElement.assignmentElement.audioUpload": "Hochladen",
	"components.cardElement.assignmentElement.exportCsv": "CSV exportieren",
	...
	"components.cardElement.assignmentElement.sectionSubmission": "Abgabe",
	"components.cardElement.assignmentElement.sectionCorrection": "Meine Korrektur",
	"components.cardElement.assignmentElement.correctionFile": "Korrektur ({date})",
	"components.cardElement.assignmentElement.filter.all": "Alle",
	"components.cardElement.assignmentElement.filter.open": "Offen",
	"components.cardElement.assignmentElement.filter.submitted": "Eingereicht",
	"components.cardElement.assignmentElement.filter.returned": "Zurückgegeben",
	"components.cardElement.assignmentElement.filter.late": "Verspätet",
	...
	"components.cardElement.assignmentElement.sort.date": "Abgabezeit (neu–alt)",
	...
	"components.cardElement.assignmentElement.csv.submittedAt": "Abgegeben am",
	"components.cardElement.assignmentElement.csv.late": "Verspätet",
	"components.cardElement.assignmentElement.csv.points": "Punkte",
	"components.cardElement.assignmentElement.csv.file": "Datei",
	"components.cardElement.assignmentElement.feedbackHeading": "Rückmeldung",
	"components.cardElement.assignmentElement.viewFile": "Ansehen",
	"components.cardElement.assignmentElement.annotate": "Korrigieren",
	...
	"components.cardElement.assignmentElement.annotator.comment": "Kommentar",
	"components.cardElement.assignmentElement.annotator.commentPlaceholder": "Kommentar eintippen",
	"components.cardElement.assignmentElement.annotator.commentDone": "Fertig",
	...
	"components.cardElement.assignmentElement.annotator.widthThick": "Dicke Linie",
	"components.cardElement.assignmentElement.annotator.colorBlack": "Schwarz",
	"components.cardElement.assignmentElement.annotator.colorRed": "Rot",
	"components.cardElement.assignmentElement.annotator.colorBlue": "Blau",
	"components.cardElement.assignmentElement.annotator.colorGreen": "Grün",
	"components.cardElement.assignmentElement.annotator.page": "Seite {current} von {total}",
	"components.cardElement.assignmentElement.annotator.fingerDraws": "Finger zeichnet",
	"components.cardElement.assignmentElement.annotator.fingerNavigates": "Finger navigiert",
	"components.cardElement.assignmentElement.annotator.fitToPage": "An Seite anpassen",
	"components.cardElement.assignmentElement.batchReturn.selectAllGraded": "Alle bewerteten auswählen",
	"components.cardElement.assignmentElement.batchReturn.button": "{count} zurückgeben",
	"components.cardElement.assignmentElement.batchReturn.confirmTitle": "Sammelrückgabe",
	"components.cardElement.assignmentElement.batchReturn.confirmBody": "{count} Abgaben werden zurückgegeben.",
	"components.cardElement.assignmentElement.batchReturn.resultSuccess": "{count} Abgaben zurückgegeben.",
	"components.cardElement.assignmentElement.batchReturn.resultPartialFailure":
		"{returned} zurückgegeben, {failed} übersprungen (noch nicht bewertet).",
	"components.cardElement.assignmentElement.versions.entry": "Version {version} · {date}",
	"components.cardElement.assignmentElement.rubric.enable": "Bewertungsraster verwenden",
	"components.cardElement.assignmentElement.rubric.criterionName": "Kriterium",
	"components.cardElement.assignmentElement.rubric.criterionMaxPoints": "Max. Punkte",
	"components.cardElement.assignmentElement.rubric.addCriterion": "Kriterium hinzufügen",
	"components.cardElement.assignmentElement.rubric.removeCriterion": "Kriterium entfernen",
	"components.cardElement.assignmentElement.peerReview.enable": "Peer-Review aktivieren",
	"components.cardElement.assignmentElement.peerReview.mode": "Zuteilung",
	"components.cardElement.assignmentElement.peerReview.modeManual": "Manuell",
	"components.cardElement.assignmentElement.peerReview.modeAuto": "Automatisch",
	"components.cardElement.assignmentElement.peerReview.count": "Anzahl Reviewer je Abgabe",
	...
	"components.cardElement.assignmentElement.peerReview.noTasks": "Aktuell keine Peer-Reviews zu bearbeiten.",
	"components.cardElement.assignmentElement.peerReview.submitReview": "Bewertung abschicken",
	"components.cardElement.assignmentElement.peerReview.reviewSubmitted": "Bewertung gespeichert.",
	...
	"components.cardElement.aiQuestionElement": "KI-Frage",
	"components.cardElement.aiQuestionElement.question": "Frage",
	"components.cardElement.aiQuestionElement.questionPlaceholder": "Frage stellen …",
	"components.cardElement.aiQuestionElement.aiInstructions": "Hinweise für die KI",
	"components.cardElement.aiQuestionElement.aiInstructionsPlaceholder":
		"Worauf soll die KI achten? Wie soll sie antworten?",
	"components.cardElement.aiQuestionElement.expectedAnswer": "Erwartete Antwort",
	...
	"components.cardElement.aiQuestionElement.gradeLevel": "Jahrgang (optional)",
	"components.cardElement.aiQuestionElement.subject": "Fach (optional)",
	"components.cardElement.aiQuestionElement.pointsEnabled": "Antwort mit Punkten bewerten",
	"components.cardElement.aiQuestionElement.maxPoints": "Maximale Punktzahl",
	"components.cardElement.aiQuestionElement.points": "{points} von {maxPoints} Punkten",
	"components.cardElement.aiQuestionElement.aiFlagged": "Die KI hat diese Antwort als themenfremd markiert.",
	"components.cardElement.aiQuestionElement.flagAssessment": "Mit Bewertung nicht einverstanden",
	"components.cardElement.aiQuestionElement.unflagAssessment": "Markierung zurücknehmen",
	"components.cardElement.aiQuestionElement.flaggedForReview": "Zur Prüfung markiert",
	"components.cardElement.aiQuestionElement.studentFlagged": "Von Schülerin oder Schüler markiert",
	"components.cardElement.aiQuestionElement.evaluation": "Auswertung der KI-Frage",
	"components.cardElement.aiQuestionElement.openEvaluation": "Auswertung öffnen",
	"components.cardElement.aiQuestionElement.gradedCount": "Mit Punkten: {count}",
	"components.cardElement.aiQuestionElement.flaggedCount": "Markiert: {count}",
	"components.cardElement.aiQuestionElement.noPoints": "Keine Punktebewertung",
	"components.cardElement.aiQuestionElement.studentAnswer": "Antwort der Schülerin oder des Schülers",
	"components.cardElement.aiQuestionElement.selectAnswer": "Wähle eine Antwort aus",
	...
	"components.cardElement.aiQuestionElement.resubmit": "Antwort erneut einreichen",
	...
	"components.cardElement.aiQuestionElement.attemptsColumn": "Versuche",
	"components.board.menu.aiQuestionElement": "KI-Frage-Einstellungen",
	...
	"components.cardElement.fileElement.textTruncated":
		"Die Datei ist zu groß, um sie vollständig anzuzeigen. Nur der Anfang wird angezeigt.",
	...
	"components.cardElement.assignmentElement.status.returned": "Zurückgegeben",
	"components.cardElement.assignmentElement.status.late": "verspätet",
	"pages.assignments.current": "Aktuell",
	"pages.assignments.past": "Vergangen",
	"pages.assignments.empty": "Keine Aufgaben vorhanden",
	"pages.assignments.submissions": "Abgaben: {submitted}/{total}",
	"pages.room.assignments.title": "Aufgaben",
	"pages.tasks.tabs.assignments": "Aufgaben",
	"pages.tasks.tabs.classic": "Klassisch",
	...
	"components.elementTypeSelection.elements.aiQuestionElement.subtitle": "KI-Frage",
	"components.elementTypeSelection.elements.assignmentElement.subtitle": "Aufgabe",
	...
	"feature-copy.notifications.duplicationInProgress":
		"{type} wird gerade dupliziert. Dies dauert länger als erwartet. Bitte später erneut prüfen. | {type} werden gerade dupliziert. Dies dauert länger als erwartet. Bitte später erneut prüfen.",
	...
	"global.topbar.actions.openMenu": "Menü öffnen",
	"global.topbar.actions.closeMenu": "Menü schließen",
	"global.topbar.theme.label": "Darstellung",
	"global.topbar.theme.system": "System",
	"global.topbar.theme.light": "Hell",
	"global.topbar.theme.dark": "Dunkel",
	...
	"pages.dashboard.features.dismiss": "Nicht mehr anzeigen",
	...
	"pages.dashboard.tasks.group.overdue": "Überfällig",
	"pages.dashboard.tasks.group.today": "Heute fällig",
	"pages.dashboard.tasks.group.thisWeek": "Diese Woche fällig",
	"pages.dashboard.tasks.group.later": "Später fällig",
	"pages.dashboard.tasks.group.noDueDate": "Ohne Fälligkeitsdatum",
	"pages.dashboard.tasks.legend": "Legende: Status der Aufgaben",
	...
	"pages.room.progress.tab.items": "Inhalte",
	...
	"pages.roomDetails.progress.link": "Fortschritt ansehen",
