export default {
	...
	"pages.learningRoom.empty.description":
		"Markiere Karten in deinen Räumen mit dem Pin-Symbol. Sie erscheinen dann hier — und bleiben mit dem Original verbunden.",
	"pages.learningRoom.empty.action": "Zu meinen Räumen",
	"pages.learningRoom.groupBy.status": "Nach Status",
	"pages.learningRoom.groupBy.room": "Nach Raum",
	"pages.learningRoom.card.unavailable": "Diese Karte ist nicht mehr verfügbar.",
	"pages.learningRoom.column.roomFallback": "Ohne Raum",
