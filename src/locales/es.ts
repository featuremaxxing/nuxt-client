export default {
	...
	"pages.learningRoom.empty.description":
		"Marca las tarjetas de tus salas con el icono de chincheta. Aparecerán aquí, siempre conectadas con el original.",
	"pages.learningRoom.empty.action": "Ir a mis salas",
	"pages.learningRoom.groupBy.status": "Por estado",
	"pages.learningRoom.groupBy.room": "Por sala",
	"pages.learningRoom.card.unavailable": "Esta tarjeta ya no está disponible.",
	"pages.learningRoom.column.roomFallback": "Sin sala",
