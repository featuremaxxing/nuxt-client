export default {
	...
	"components.boardProgress.doneOf": "{done}/{total} completado",
	"components.boardProgress.classProgress": "{done}/{total} de la clase completado",
	"components.boardProgress.students.allDone": "Todo completado",
	"components.boardProgress.students.openItems": "Pendiente",
	"components.boardProgress.students.overdue": "atrasado",
	...
	"components.cardElement.checkboxElement.unchecked": "No hecho",
	"components.cardElement.checkboxElement.checked": "Hecho",
	"components.cardElement.checkboxElement.revoke": "Revocar aprobación",
	"components.cardElement.checkboxElement.confirm": "Aprobar",
	"components.cardElement.checkboxElement.students": "Participantes",
	"components.cardElement.checkboxElement.details": "Detalles",
	"components.cardElement.checkboxElement.progress": "completados",
	"components.cardElement.checkboxElement.status": "Estado",
	"components.cardElement.checkboxElement.pending": "Pendiente de aprobación",
	"components.cardElement.checkboxElement.approved": "Aprobado",
	"components.cardElement.checkboxElement.approvalRequired": "Requiere aprobación del docente",
	"components.cardElement.checkboxElement.approvalLocked":
		"Esta opción no se puede cambiar después de la primera acción.",
	"components.cardElement.checkboxElement.audienceLabel": "Público",
	"components.cardElement.checkboxElement.audience.students": "Estudiantes",
	"components.cardElement.checkboxElement.audience.teachers": "Docentes",
	"components.cardElement.checkboxElement.audience.all": "Todos",
	"components.cardElement.checkboxElement.audience.custom": "Personalizado",
	"components.cardElement.checkboxElement.audienceRole.reader": "Lector",
	"components.cardElement.checkboxElement.audienceRole.editor": "Editor",
	"components.cardElement.checkboxElement.audienceRole.admin": "Administrador",
	"components.cardElement.checkboxElement.text": "Tarea",
	"components.cardElement.checkboxElement": "Casilla",
	"components.cardElement.pollElement.titleLabel": "Título",
	"components.cardElement.pollElement.questionLabel": "Pregunta {number}",
	"components.cardElement.pollElement.answerModeLabel": "Tipo de respuesta",
	"components.cardElement.pollElement.chartTypeLabel": "Tipo de gráfico",
	"components.cardElement.pollElement.optionLabel": "Respuesta {number}",
	"components.cardElement.pollElement.addQuestion": "Añadir pregunta",
	"components.cardElement.pollElement.addOption": "Añadir respuesta",
	"components.cardElement.pollElement.answerMode.single": "Selección única",
	"components.cardElement.pollElement.answerMode.multiple": "Selección múltiple",
	"components.cardElement.pollElement.answerMode.text": "Texto libre",
	"components.cardElement.pollElement.chartType.bar": "Barras (horizontal)",
	"components.cardElement.pollElement.chartType.column": "Columnas (vertical)",
	"components.cardElement.pollElement.chartType.donut": "Anillo",
	"components.cardElement.pollElement.chartType.stacked": "Barras apiladas",
	"components.cardElement.pollElement.anonymous": "Encuesta anónima",
	"components.cardElement.pollElement.liveResults": "Mostrar resultados en vivo",
	"components.cardElement.pollElement.allowVoteChange": "Permitir cambiar las respuestas enviadas",
	"components.cardElement.pollElement.audienceLabel": "¿Quién puede votar?",
	"components.cardElement.pollElement.audience.students": "Solo estudiantes",
	"components.cardElement.pollElement.audience.teachers": "Docentes y personal",
	"components.cardElement.pollElement.audience.all": "Todos los miembros de la sala",
	"components.cardElement.pollElement.audience.custom": "Personalizado…",
	"components.cardElement.pollElement.audienceRolesLabel": "Roles con derecho a voto",
	"components.cardElement.pollElement.audienceRole.reader": "Espectadores",
	"components.cardElement.pollElement.audienceRole.editor": "Editores",
	"components.cardElement.pollElement.audienceRole.admin": "Administradores y propietarios",
	"components.cardElement.pollElement.audienceLockedHint":
		"El grupo destinatario ya no se puede cambiar una vez emitido un voto.",
	"components.cardElement.pollElement.structureLockedHint":
		"Una vez emitido un voto, solo se pueden añadir preguntas y opciones, no eliminarlas. Tampoco se puede cambiar el tipo de respuesta.",
	"components.cardElement.pollElement.status.draft": "Borrador",
	"components.cardElement.pollElement.status.open": "Abierta",
	"components.cardElement.pollElement.status.closed": "Cerrada",
	"components.cardElement.pollElement.open": "Abrir",
	"components.cardElement.pollElement.close": "Cerrar",
	"components.cardElement.pollElement.vote": "Votar",
	"components.cardElement.pollElement.changeVote": "Cambiar respuesta",
	"components.cardElement.pollElement.voteRecorded": "Tu respuesta ha sido guardada.",
	"components.cardElement.pollElement.votedCount": "{voted} de {total} han votado",
	"components.cardElement.pollElement.closesAt": "Finaliza el",
	"components.cardElement.pollElement.opensAtLabel": "Hora de inicio",
	"components.cardElement.pollElement.remainingMinutes": "quedan {minutes} min",
	"components.cardElement.pollElement.closed": "Finalizada",
	"components.cardElement.pollElement.startsAtLabel": "Inicio: {date}",
	"components.cardElement.pollElement.closesAtLabel": "Fin: {date}",
	"components.cardElement.pollElement.notStartedYet": "Empieza el {date}",
	"components.cardElement.pollElement.exportCsv": "Exportar como CSV",
	"components.cardElement.pollElement.exportPdf": "Exportar como PDF",
	...
	"components.cardElement.pollElement.answerLocked": "Ya respondida",
	"components.cardElement.pollElement.newQuestions": "Nueva",
	...
	"components.cardElement.pollElement.previousQuestion": "Pregunta anterior",
	"components.cardElement.pollElement.nextQuestion": "Siguiente pregunta",
	"components.cardElement.pollElement.noParticipants": "Aún no hay participación",
	"components.cardElement.pollElement.unknownUser": "Persona desconocida",
	"components.cardElement.pollElement.answerColumn": "Respuesta",
	"components.cardElement.pollElement.nameColumn": "Nombre",
	"components.cardElement.assignmentElement": "Tarea",
	...
	"components.cardElement.assignmentElement.graceMinutes.none": "Ninguno",
	"components.cardElement.assignmentElement.graceMinutes.15m": "15 minutos",
	"components.cardElement.assignmentElement.graceMinutes.1h": "1 hora",
	"components.cardElement.assignmentElement.graceMinutes.12h": "12 horas",
	"components.cardElement.assignmentElement.graceMinutes.1d": "1 día",
	"components.cardElement.assignmentElement.graceMinutes.3d": "3 días",
	"components.cardElement.assignmentElement.maxPoints": "Puntuación máxima",
	"components.cardElement.assignmentElement.points": "{points} / {maxPoints} puntos",
	"components.cardElement.assignmentElement.uploadFile": "Subir archivo",
	"components.cardElement.assignmentElement.replaceFile": "Reemplazar archivo",
	"components.cardElement.assignmentElement.closed": "La entrega ya no es posible",
	"components.cardElement.assignmentElement.viewSubmissions": "Ver entregas ({submitted}/{total})",
	"components.cardElement.assignmentElement.submittedOf": "{submitted} de {total} entregadas",
	"components.cardElement.assignmentElement.submissionsProgress": "{graded} calificadas · {open} abiertas",
	"components.cardElement.assignmentElement.submissionsTitle": "Entregas",
	"components.cardElement.assignmentElement.pointsLabel": "Puntos",
	"components.cardElement.assignmentElement.returnSubmission": "Devolver",
	"components.cardElement.assignmentElement.downloadFile": "Descargar",
	...
	"components.cardElement.assignmentElement.audioUpload": "Subir",
	"components.cardElement.assignmentElement.exportCsv": "Exportar CSV",
	...
	"components.cardElement.assignmentElement.sectionSubmission": "Entrega",
	"components.cardElement.assignmentElement.sectionCorrection": "Mi corrección",
	"components.cardElement.assignmentElement.correctionFile": "Corrección ({date})",
	"components.cardElement.assignmentElement.filter.all": "Todas",
	"components.cardElement.assignmentElement.filter.open": "Abiertas",
	"components.cardElement.assignmentElement.filter.submitted": "Entregadas",
	"components.cardElement.assignmentElement.filter.returned": "Devueltas",
	"components.cardElement.assignmentElement.filter.late": "Con retraso",
	"components.cardElement.assignmentElement.sort.name": "Nombre (A–Z)",
	"components.cardElement.assignmentElement.sort.nameDesc": "Nombre (Z–A)",
	"components.cardElement.assignmentElement.sort.date": "Fecha de entrega (reciente)",
	"components.cardElement.assignmentElement.sort.status": "Estado",
	"components.cardElement.assignmentElement.csv.name": "Nombre",
	"components.cardElement.assignmentElement.csv.status": "Estado",
	"components.cardElement.assignmentElement.csv.submittedAt": "Entregado el",
	"components.cardElement.assignmentElement.csv.late": "Con retraso",
	"components.cardElement.assignmentElement.csv.points": "Puntos",
	"components.cardElement.assignmentElement.csv.file": "Archivo",
	"components.cardElement.assignmentElement.feedbackHeading": "Retroalimentación",
	"components.cardElement.assignmentElement.viewFile": "Ver",
	"components.cardElement.assignmentElement.annotate": "Corregir",
	...
	"components.cardElement.assignmentElement.annotator.comment": "Comentario",
	"components.cardElement.assignmentElement.annotator.commentPlaceholder": "Escribe un comentario",
	"components.cardElement.assignmentElement.annotator.commentDone": "Listo",
	...
	"components.cardElement.assignmentElement.annotator.widthThick": "Línea gruesa",
	"components.cardElement.assignmentElement.annotator.colorBlack": "Negro",
	"components.cardElement.assignmentElement.annotator.colorRed": "Rojo",
	"components.cardElement.assignmentElement.annotator.colorBlue": "Azul",
	"components.cardElement.assignmentElement.annotator.colorGreen": "Verde",
	"components.cardElement.assignmentElement.annotator.page": "Página {current} de {total}",
	"components.cardElement.assignmentElement.annotator.fingerDraws": "El dedo dibuja",
	"components.cardElement.assignmentElement.annotator.fingerNavigates": "El dedo navega",
	"components.cardElement.assignmentElement.annotator.fitToPage": "Ajustar a la página",
	"components.cardElement.assignmentElement.batchReturn.selectAllGraded": "Seleccionar todas las calificadas",
	"components.cardElement.assignmentElement.batchReturn.button": "Devolver {count}",
	"components.cardElement.assignmentElement.batchReturn.confirmTitle": "Devolución en lote",
	"components.cardElement.assignmentElement.batchReturn.confirmBody": "Se devolverán {count} entregas.",
	"components.cardElement.assignmentElement.batchReturn.resultSuccess": "{count} entregas devueltas.",
	"components.cardElement.assignmentElement.batchReturn.resultPartialFailure":
		"{returned} devueltas, {failed} omitidas (aún no calificadas).",
	"components.cardElement.assignmentElement.versions.entry": "Versión {version} · {date}",
	"components.cardElement.assignmentElement.rubric.enable": "Usar rúbrica de evaluación",
	"components.cardElement.assignmentElement.rubric.criterionName": "Criterio",
	"components.cardElement.assignmentElement.rubric.criterionMaxPoints": "Puntos máx.",
	"components.cardElement.assignmentElement.rubric.addCriterion": "Añadir criterio",
	"components.cardElement.assignmentElement.rubric.removeCriterion": "Eliminar criterio",
	"components.cardElement.assignmentElement.peerReview.enable": "Activar evaluación entre pares",
	"components.cardElement.assignmentElement.peerReview.mode": "Modo de asignación",
	"components.cardElement.assignmentElement.peerReview.modeManual": "Manual",
	"components.cardElement.assignmentElement.peerReview.modeAuto": "Automático",
	"components.cardElement.assignmentElement.peerReview.count": "Revisores por entrega",
	"components.cardElement.assignmentElement.peerReview.autoAssign": "Asignar automáticamente",
	"components.cardElement.assignmentElement.peerReview.manualAssign": "Asignar",
	"components.cardElement.assignmentElement.peerReview.manageTitle": "Gestionar evaluación entre pares",
	"components.cardElement.assignmentElement.peerReview.manageButton": "Evaluación entre pares",
	"components.cardElement.assignmentElement.peerReview.selectReviewer": "Seleccionar revisor",
	"components.cardElement.assignmentElement.peerReview.removeAssignment": "Eliminar asignación",
	"components.cardElement.assignmentElement.peerReview.assignmentSubmitted": "Ya enviada - no se puede eliminar",
	"components.cardElement.assignmentElement.peerReview.autoAssignSuccess": "{count} asignaciones realizadas.",
	"components.cardElement.assignmentElement.peerReview.manualAssignSuccess": "Asignación guardada.",
	"components.cardElement.assignmentElement.peerReview.myTasks": "Mis evaluaciones entre pares",
	"components.cardElement.assignmentElement.peerReview.noTasks": "No hay evaluaciones pendientes por ahora.",
	"components.cardElement.assignmentElement.peerReview.submitReview": "Enviar evaluación",
	"components.cardElement.assignmentElement.peerReview.reviewSubmitted": "Evaluación guardada.",
	"components.cardElement.assignmentElement.peerReview.advisoryNotice":
	...
	"components.cardElement.aiQuestionElement": "Pregunta de IA",
	"components.cardElement.aiQuestionElement.question": "Pregunta",
	"components.cardElement.aiQuestionElement.questionPlaceholder": "Hacer una pregunta …",
	"components.cardElement.aiQuestionElement.aiInstructions": "Instrucciones para la IA",
	"components.cardElement.aiQuestionElement.aiInstructionsPlaceholder":
		"¿En qué debe fijarse la IA? ¿Cómo debe responder?",
	"components.cardElement.aiQuestionElement.expectedAnswer": "Respuesta esperada",
	...
	"components.cardElement.aiQuestionElement.gradeLevel": "Curso (opcional)",
	"components.cardElement.aiQuestionElement.subject": "Asignatura (opcional)",
	"components.cardElement.aiQuestionElement.pointsEnabled": "Evaluar la respuesta con puntos",
	"components.cardElement.aiQuestionElement.maxPoints": "Puntuación máxima",
	"components.cardElement.aiQuestionElement.points": "{points} de {maxPoints} puntos",
	"components.cardElement.aiQuestionElement.aiFlagged": "La IA marcó esta respuesta como fuera de tema.",
	"components.cardElement.aiQuestionElement.flagAssessment": "No estoy de acuerdo con la evaluación",
	"components.cardElement.aiQuestionElement.unflagAssessment": "Retirar la marca",
	"components.cardElement.aiQuestionElement.flaggedForReview": "Marcada para revisión",
	"components.cardElement.aiQuestionElement.studentFlagged": "Marcada por el estudiante",
	"components.cardElement.aiQuestionElement.evaluation": "Evaluación de la pregunta de IA",
	"components.cardElement.aiQuestionElement.openEvaluation": "Abrir evaluación",
	"components.cardElement.aiQuestionElement.gradedCount": "Con puntos: {count}",
	"components.cardElement.aiQuestionElement.flaggedCount": "Marcadas: {count}",
	"components.cardElement.aiQuestionElement.noPoints": "Sin evaluación por puntos",
	"components.cardElement.aiQuestionElement.studentAnswer": "Respuesta del estudiante",
	"components.cardElement.aiQuestionElement.selectAnswer": "Selecciona una respuesta",
	...
	"components.cardElement.aiQuestionElement.resubmit": "Enviar una nueva respuesta",
	"components.cardElement.aiQuestionElement.attempt": "Intento {count}",
	"components.cardElement.aiQuestionElement.singleAttemptHint": "Solo puedes responder esta pregunta una vez.",
	"components.cardElement.aiQuestionElement.aiResponseTitle": "Evaluación de la IA",
	"components.cardElement.aiQuestionElement.aiError": "La IA no está disponible ahora. Inténtalo más tarde.",
	"components.cardElement.aiQuestionElement.aiThinking": "La IA está evaluando tu respuesta …",
	"components.cardElement.aiQuestionElement.answersCount": "Respuestas ({count})",
	"components.cardElement.aiQuestionElement.answersEmpty": "Aún no hay respuestas.",
	"components.cardElement.aiQuestionElement.attemptsColumn": "Intentos",
	"components.board.menu.aiQuestionElement": "Ajustes de la pregunta de IA",
	...
	"components.cardElement.assignmentElement.status.returned": "Devuelta",
	"components.cardElement.assignmentElement.status.late": "tardía",
	"pages.assignments.current": "Actuales",
	...
	"global.topbar.actions.openMenu": "Abrir menú",
	"global.topbar.actions.closeMenu": "Cerrar menú",
	"global.topbar.theme.label": "Apariencia",
	"global.topbar.theme.system": "Sistema",
	"global.topbar.theme.light": "Claro",
	"global.topbar.theme.dark": "Oscuro",
	...
	"pages.dashboard.features.dismiss": "No mostrar más",
	...
	"pages.dashboard.tasks.group.overdue": "Atrasado",
	"pages.dashboard.tasks.group.today": "Vence hoy",
	"pages.dashboard.tasks.group.thisWeek": "Vence esta semana",
	"pages.dashboard.tasks.group.later": "Vence más tarde",
	"pages.dashboard.tasks.group.noDueDate": "Sin fecha de entrega",
	"pages.dashboard.tasks.legend": "Leyenda: estado de las tareas",
	...
	"pages.room.progress.tab.items": "Contenidos",
	...
	"pages.roomDetails.progress.link": "Ver progreso",
