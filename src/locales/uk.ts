export default {
	...
	"components.board.menu.checkboxElement": "Налаштування прапорця",
	"components.board.menu.assignmentElement": "Налаштування завдання",
	...
	"components.boardProgress.doneOf": "{done}/{total} виконано",
	"components.boardProgress.classProgress": "{done}/{total} класу виконано",
	"components.boardProgress.students.allDone": "Усе виконано",
	"components.boardProgress.students.openItems": "Ще не виконано",
	"components.boardProgress.students.overdue": "прострочено",
	...
	"components.cardElement.checkboxElement.unchecked": "Не виконано",
	"components.cardElement.checkboxElement.checked": "Виконано",
	"components.cardElement.checkboxElement.revoke": "Скасувати підтвердження",
	"components.cardElement.checkboxElement.confirm": "Підтвердити",
	"components.cardElement.checkboxElement.students": "Учасники",
	"components.cardElement.checkboxElement.details": "Деталі",
	"components.cardElement.checkboxElement.progress": "виконано",
	"components.cardElement.checkboxElement.status": "Статус",
	"components.cardElement.checkboxElement.pending": "Очікує підтвердження",
	"components.cardElement.checkboxElement.approved": "Підтверджено",
	"components.cardElement.checkboxElement.approvalRequired": "Потрібне підтвердження вчителя",
	"components.cardElement.checkboxElement.approvalLocked":
		"Цей параметр не можна змінити після першої дії з прапорцем.",
	"components.cardElement.checkboxElement.audienceLabel": "Аудиторія",
	"components.cardElement.checkboxElement.audience.students": "Учні",
	"components.cardElement.checkboxElement.audience.teachers": "Вчителі",
	"components.cardElement.checkboxElement.audience.all": "Усі",
	"components.cardElement.checkboxElement.audience.custom": "Власний вибір",
	"components.cardElement.checkboxElement.audienceRole.reader": "Читач",
	"components.cardElement.checkboxElement.audienceRole.editor": "Редактор",
	"components.cardElement.checkboxElement.audienceRole.admin": "Адміністратор",
	"components.cardElement.checkboxElement.text": "Завдання",
	"components.cardElement.checkboxElement": "Прапорець",
	"components.cardElement.pollElement.titleLabel": "Назва",
	"components.cardElement.pollElement.questionLabel": "Питання {number}",
	"components.cardElement.pollElement.answerModeLabel": "Тип відповіді",
	"components.cardElement.pollElement.chartTypeLabel": "Тип діаграми",
	"components.cardElement.pollElement.optionLabel": "Відповідь {number}",
	"components.cardElement.pollElement.addQuestion": "Додати питання",
	"components.cardElement.pollElement.addOption": "Додати відповідь",
	"components.cardElement.pollElement.answerMode.single": "Одиночний вибір",
	"components.cardElement.pollElement.answerMode.multiple": "Множинний вибір",
	"components.cardElement.pollElement.answerMode.text": "Вільний текст",
	"components.cardElement.pollElement.chartType.bar": "Стовпці (горизонтально)",
	"components.cardElement.pollElement.chartType.column": "Стовпці (вертикально)",
	"components.cardElement.pollElement.chartType.donut": "Кільцева діаграма",
	"components.cardElement.pollElement.chartType.stacked": "Складена діаграма",
	"components.cardElement.pollElement.anonymous": "Анонімне опитування",
	"components.cardElement.pollElement.liveResults": "Показувати результати наживо",
	"components.cardElement.pollElement.allowVoteChange": "Дозволити змінювати надіслані відповіді",
	"components.cardElement.pollElement.audienceLabel": "Хто може голосувати?",
	"components.cardElement.pollElement.audience.students": "Лише учні",
	"components.cardElement.pollElement.audience.teachers": "Вчителі та персонал",
	"components.cardElement.pollElement.audience.all": "Усі учасники кімнати",
	"components.cardElement.pollElement.audience.custom": "Налаштувати…",
	"components.cardElement.pollElement.audienceRolesLabel": "Ролі з правом голосу",
	"components.cardElement.pollElement.audienceRole.reader": "Глядачі",
	"components.cardElement.pollElement.audienceRole.editor": "Редактори",
	"components.cardElement.pollElement.audienceRole.admin": "Адміністратори та власники",
	"components.cardElement.pollElement.audienceLockedHint":
		"Цільову аудиторію не можна змінити після того, як подано перший голос.",
	"components.cardElement.pollElement.structureLockedHint":
		"Після першого голосу питання та варіанти відповідей можна лише додавати, але не видаляти. Тип відповіді також більше не можна змінити.",
	"components.cardElement.pollElement.status.draft": "Чернетка",
	"components.cardElement.pollElement.status.open": "Відкрито",
	"components.cardElement.pollElement.status.closed": "Закрито",
	"components.cardElement.pollElement.open": "Відкрити",
	"components.cardElement.pollElement.close": "Закрити",
	"components.cardElement.pollElement.vote": "Проголосувати",
	"components.cardElement.pollElement.changeVote": "Змінити відповідь",
	"components.cardElement.pollElement.voteRecorded": "Вашу відповідь збережено.",
	"components.cardElement.pollElement.votedCount": "{voted} з {total} проголосували",
	"components.cardElement.pollElement.closesAt": "Завершується",
	"components.cardElement.pollElement.opensAtLabel": "Час початку",
	"components.cardElement.pollElement.remainingMinutes": "залишилось {minutes} хв",
	"components.cardElement.pollElement.closed": "Завершено",
	"components.cardElement.pollElement.startsAtLabel": "Початок: {date}",
	"components.cardElement.pollElement.closesAtLabel": "Кінець: {date}",
	"components.cardElement.pollElement.notStartedYet": "Починається {date}",
	"components.cardElement.pollElement.exportCsv": "Експортувати як CSV",
	"components.cardElement.pollElement.exportPdf": "Експортувати як PDF",
	...
	"components.cardElement.pollElement.answerLocked": "Вже відповіли",
	"components.cardElement.pollElement.newQuestions": "Нове",
	...
	"components.cardElement.pollElement.previousQuestion": "Попереднє запитання",
	"components.cardElement.pollElement.nextQuestion": "Наступне запитання",
	"components.cardElement.pollElement.noParticipants": "Ще немає участі",
	"components.cardElement.pollElement.unknownUser": "Невідома особа",
	"components.cardElement.pollElement.answerColumn": "Відповідь",
	"components.cardElement.pollElement.nameColumn": "Ім'я",
	"components.cardElement.assignmentElement": "Завдання",
	...
	"components.cardElement.assignmentElement.graceMinutes.none": "Немає",
	"components.cardElement.assignmentElement.graceMinutes.15m": "15 хвилин",
	"components.cardElement.assignmentElement.graceMinutes.1h": "1 година",
	"components.cardElement.assignmentElement.graceMinutes.12h": "12 годин",
	"components.cardElement.assignmentElement.graceMinutes.1d": "1 день",
	"components.cardElement.assignmentElement.graceMinutes.3d": "3 дні",
	"components.cardElement.assignmentElement.maxPoints": "Максимальна кількість балів",
	"components.cardElement.assignmentElement.points": "{points} / {maxPoints} балів",
	"components.cardElement.assignmentElement.uploadFile": "Завантажити файл",
	"components.cardElement.assignmentElement.replaceFile": "Замінити файл",
	"components.cardElement.assignmentElement.closed": "Здача більше неможлива",
	"components.cardElement.assignmentElement.viewSubmissions": "Переглянути роботи ({submitted}/{total})",
	"components.cardElement.assignmentElement.submittedOf": "{submitted} з {total} здано",
	"components.cardElement.assignmentElement.submissionsProgress": "{graded} оцінено · {open} відкрито",
	"components.cardElement.assignmentElement.submissionsTitle": "Здані роботи",
	"components.cardElement.assignmentElement.pointsLabel": "Бали",
	...
	"components.cardElement.assignmentElement.audioUpload": "Завантажити",
	"components.cardElement.assignmentElement.exportCsv": "Експорт CSV",
	...
	"components.cardElement.assignmentElement.sectionSubmission": "Робота",
	"components.cardElement.assignmentElement.sectionCorrection": "Моя корекція",
	"components.cardElement.assignmentElement.correctionFile": "Корекція ({date})",
	"components.cardElement.assignmentElement.filter.all": "Усі",
	"components.cardElement.assignmentElement.filter.open": "Відкриті",
	"components.cardElement.assignmentElement.filter.submitted": "Здані",
	"components.cardElement.assignmentElement.filter.returned": "Повернуті",
	"components.cardElement.assignmentElement.filter.late": "З запізненням",
	"components.cardElement.assignmentElement.sort.name": "Ім'я (A–Z)",
	"components.cardElement.assignmentElement.sort.nameDesc": "Ім'я (Z–A)",
	"components.cardElement.assignmentElement.sort.date": "Дата здавання (новіші)",
	"components.cardElement.assignmentElement.sort.status": "Статус",
	"components.cardElement.assignmentElement.csv.name": "Ім'я",
	"components.cardElement.assignmentElement.csv.status": "Статус",
	"components.cardElement.assignmentElement.csv.submittedAt": "Здано",
	"components.cardElement.assignmentElement.csv.late": "З запізненням",
	"components.cardElement.assignmentElement.csv.points": "Бали",
	"components.cardElement.assignmentElement.csv.file": "Файл",
	"components.cardElement.assignmentElement.feedbackHeading": "Відгук",
	"components.cardElement.assignmentElement.viewFile": "Переглянути",
	...
	"components.cardElement.assignmentElement.annotator.comment": "Коментар",
	"components.cardElement.assignmentElement.annotator.commentPlaceholder": "Введіть коментар",
	"components.cardElement.assignmentElement.annotator.commentDone": "Готово",
	...
	"components.cardElement.assignmentElement.annotator.widthThick": "Товста лінія",
	"components.cardElement.assignmentElement.annotator.colorBlack": "Чорний",
	"components.cardElement.assignmentElement.annotator.colorRed": "Червоний",
	"components.cardElement.assignmentElement.annotator.colorBlue": "Синій",
	"components.cardElement.assignmentElement.annotator.colorGreen": "Зелений",
	"components.cardElement.assignmentElement.annotator.page": "Сторінка {current} з {total}",
	"components.cardElement.assignmentElement.annotator.fingerDraws": "Палець малює",
	"components.cardElement.assignmentElement.annotator.fingerNavigates": "Палець гортає",
	"components.cardElement.assignmentElement.annotator.fitToPage": "За розміром сторінки",
	"components.cardElement.assignmentElement.batchReturn.selectAllGraded": "Вибрати всі оцінені",
	"components.cardElement.assignmentElement.batchReturn.button": "Повернути {count}",
	"components.cardElement.assignmentElement.batchReturn.confirmTitle": "Групове повернення",
	"components.cardElement.assignmentElement.batchReturn.confirmBody": "Буде повернено {count} робіт.",
	"components.cardElement.assignmentElement.batchReturn.resultSuccess": "Повернено робіт: {count}.",
	"components.cardElement.assignmentElement.batchReturn.resultPartialFailure":
		"Повернено {returned}, пропущено {failed} (ще не оцінено).",
	"components.cardElement.assignmentElement.versions.entry": "Версія {version} · {date}",
	"components.cardElement.assignmentElement.rubric.enable": "Використовувати критерії оцінювання",
	"components.cardElement.assignmentElement.rubric.criterionName": "Критерій",
	"components.cardElement.assignmentElement.rubric.criterionMaxPoints": "Макс. балів",
	"components.cardElement.assignmentElement.rubric.addCriterion": "Додати критерій",
	"components.cardElement.assignmentElement.rubric.removeCriterion": "Видалити критерій",
	"components.cardElement.assignmentElement.peerReview.enable": "Увімкнути взаємне оцінювання",
	"components.cardElement.assignmentElement.peerReview.mode": "Режим призначення",
	"components.cardElement.assignmentElement.peerReview.modeManual": "Вручну",
	"components.cardElement.assignmentElement.peerReview.modeAuto": "Автоматично",
	"components.cardElement.assignmentElement.peerReview.count": "Рецензентів на роботу",
	"components.cardElement.assignmentElement.peerReview.autoAssign": "Призначити автоматично",
	"components.cardElement.assignmentElement.peerReview.manualAssign": "Призначити",
	"components.cardElement.assignmentElement.peerReview.manageTitle": "Керування взаємним оцінюванням",
	"components.cardElement.assignmentElement.peerReview.manageButton": "Взаємне оцінювання",
	"components.cardElement.assignmentElement.peerReview.selectReviewer": "Обрати рецензента",
	"components.cardElement.assignmentElement.peerReview.removeAssignment": "Видалити призначення",
	"components.cardElement.assignmentElement.peerReview.assignmentSubmitted": "Вже надіслано - не можна видалити",
	"components.cardElement.assignmentElement.peerReview.autoAssignSuccess": "Зроблено призначень: {count}.",
	"components.cardElement.assignmentElement.peerReview.manualAssignSuccess": "Призначення збережено.",
	"components.cardElement.assignmentElement.peerReview.myTasks": "Мої взаємні рецензії",
	"components.cardElement.assignmentElement.peerReview.noTasks": "Наразі немає рецензій для виконання.",
	"components.cardElement.assignmentElement.peerReview.submitReview": "Надіслати рецензію",
	"components.cardElement.assignmentElement.peerReview.reviewSubmitted": "Рецензію збережено.",
	...
	"components.cardElement.aiQuestionElement": "Питання до ШІ",
	"components.cardElement.aiQuestionElement.question": "Питання",
	"components.cardElement.aiQuestionElement.questionPlaceholder": "Поставте запитання …",
	"components.cardElement.aiQuestionElement.aiInstructions": "Вказівки для ШІ",
	"components.cardElement.aiQuestionElement.aiInstructionsPlaceholder":
		"На що ШІ має звернути увагу? Як він має відповідати?",
	"components.cardElement.aiQuestionElement.expectedAnswer": "Очікувана відповідь",
	...
	"components.cardElement.aiQuestionElement.gradeLevel": "Клас (необов’язково)",
	"components.cardElement.aiQuestionElement.subject": "Предмет (необов’язково)",
	"components.cardElement.aiQuestionElement.pointsEnabled": "Оцінювати відповідь балами",
	"components.cardElement.aiQuestionElement.maxPoints": "Максимальна кількість балів",
	"components.cardElement.aiQuestionElement.points": "{points} з {maxPoints} балів",
	"components.cardElement.aiQuestionElement.aiFlagged": "ШІ позначив цю відповідь як таку, що не стосується теми.",
	"components.cardElement.aiQuestionElement.flagAssessment": "Не погоджуюся з оцінюванням",
	"components.cardElement.aiQuestionElement.unflagAssessment": "Зняти позначку",
	"components.cardElement.aiQuestionElement.flaggedForReview": "Позначено для перевірки",
	"components.cardElement.aiQuestionElement.studentFlagged": "Позначено учнем",
	"components.cardElement.aiQuestionElement.evaluation": "Оцінювання ШІ-запитання",
	"components.cardElement.aiQuestionElement.openEvaluation": "Відкрити оцінювання",
	"components.cardElement.aiQuestionElement.gradedCount": "З балами: {count}",
	"components.cardElement.aiQuestionElement.flaggedCount": "Позначено: {count}",
	"components.cardElement.aiQuestionElement.noPoints": "Без оцінювання балами",
	"components.cardElement.aiQuestionElement.studentAnswer": "Відповідь учня",
	"components.cardElement.aiQuestionElement.selectAnswer": "Виберіть відповідь",
	...
	"components.cardElement.aiQuestionElement.resubmit": "Надіслати нову відповідь",
	"components.cardElement.aiQuestionElement.attempt": "Спроба {count}",
	"components.cardElement.aiQuestionElement.singleAttemptHint": "На це питання можна відповісти лише один раз.",
	"components.cardElement.aiQuestionElement.aiResponseTitle": "Оцінка ШІ",
	"components.cardElement.aiQuestionElement.aiError": "ШІ наразі недоступний. Спробуйте пізніше.",
	"components.cardElement.aiQuestionElement.aiThinking": "ШІ оцінює вашу відповідь …",
	"components.cardElement.aiQuestionElement.answersCount": "Відповіді ({count})",
	"components.cardElement.aiQuestionElement.answersEmpty": "Ще немає відповідей.",
	"components.cardElement.aiQuestionElement.attemptsColumn": "Спроби",
	"components.board.menu.aiQuestionElement": "Налаштування питання до ШІ",
	...
	"components.cardElement.assignmentElement.status.returned": "Повернено",
	"components.cardElement.assignmentElement.status.late": "із запізненням",
	"pages.assignments.current": "Актуальні",
	...
	"components.elementTypeSelection.elements.checkboxElement.subtitle": "Прапорець",
	"components.elementTypeSelection.elements.aiQuestionElement.subtitle": "Питання до ШІ",
	"components.elementTypeSelection.elements.assignmentElement.subtitle": "Завдання",
	...
	"global.topbar.actions.openMenu": "Відкрити меню",
	"global.topbar.actions.closeMenu": "Закрити меню",
	"global.topbar.theme.label": "Вигляд",
	"global.topbar.theme.system": "Система",
	"global.topbar.theme.light": "Світла",
	"global.topbar.theme.dark": "Темна",
	...
	"pages.dashboard.features.dismiss": "Більше не показувати",
	...
	"pages.dashboard.tasks.group.overdue": "Прострочено",
	"pages.dashboard.tasks.group.today": "Термін сьогодні",
	"pages.dashboard.tasks.group.thisWeek": "Термін цього тижня",
	"pages.dashboard.tasks.group.later": "Термін пізніше",
	"pages.dashboard.tasks.group.noDueDate": "Без терміну здачі",
	"pages.dashboard.tasks.legend": "Легенда: стан завдань",
	...
	"pages.room.progress.tab.items": "Матеріали",
	...
	"pages.roomDetails.progress.link": "Переглянути прогрес",
