export default {
	...
	"pages.learningRoom.empty.description":
		"Позначте картки у своїх кімнатах піктограмою шпильки. Вони з’являться тут і залишатимуться пов’язаними з оригіналом.",
	"pages.learningRoom.empty.action": "До моїх кімнат",
	"pages.learningRoom.groupBy.status": "За статусом",
	"pages.learningRoom.groupBy.room": "За кімнатою",
	"pages.learningRoom.card.unavailable": "Ця картка більше недоступна.",
	"pages.learningRoom.column.roomFallback": "Без кімнати",
